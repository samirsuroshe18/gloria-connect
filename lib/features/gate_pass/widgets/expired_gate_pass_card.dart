          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      if (gatePassData.checkInCodeExpiryDate != null) ...[
                        const SizedBox(height: 8),
                        Text(
                          'Expired on: ${_formatDate(gatePassData.checkInCodeExpiryDate!)}',
                          style: TextStyle(
                            color: Colors.white70,
                            fontSize: subtitleFontSize,
                          ),
                        ...
                        Text(
                          'Time: ${_formatTime(gatePassData.checkInCodeExpiryDate!)}',
                          style: TextStyle(
                            color: Colors.white70,
                            fontSize: subtitleFontSize,
                          ),
                ...
                if (gatePassData.checkInCode != null) ...[
