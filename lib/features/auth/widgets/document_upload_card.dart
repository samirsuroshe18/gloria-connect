...
class DocumentUploadCard extends StatelessWidget {
  ...
  const DocumentUploadCard({super.key, required this.title, required this.subtitle, this.file, required this.onUpload, required this.onRemove, required this.isOwner, this.tenantAgreementType, this.ownershipDocumentType});
