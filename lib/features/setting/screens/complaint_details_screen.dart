...
//               decoration: BoxDecoration(
//                 color: isMe ? Colors.black.withOpacity(0.2) : Colors.white.withOpacity(0.2),
...
class _ComplaintDetailsScreenState extends State<ComplaintDetailsScreen> {
    ...
    return Scaffold(
      ...
      body: BlocConsumer<SettingBloc, SettingState>(
        ...
        builder: (context, state) {
          ...
          } else if (complaintModel == null && _isError == true && statusCode == 401) {
            return RefreshIndicator(
              onRefresh: _onRefreshResponse,
  ...
  Widget _buildMessageBubble(Map<String, dynamic> message, Map<String, dynamic>? data) {
    // complaintModel.responses?[0].id
    final isMe = userId == message['responseBy']['_id'];
    return Padding(
      padding: const EdgeInsets.only(bottom: 16),
