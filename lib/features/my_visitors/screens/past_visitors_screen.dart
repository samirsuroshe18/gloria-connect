...
class _PastVisitorsScreenState extends State<PastVisitorsScreen> with AutomaticKeepAliveClientMixin {
  ...
  Future<void> _fetchEntries()async {
    ...
    context.read<MyVisitorsBloc>().add(GetPastEntries(queryParams: queryParams));
  }
            ...
            child: BlocConsumer<MyVisitorsBloc, MyVisitorsState>(
              ...
              builder: (context, state) {
                if (data.isNotEmpty && _isLoading == false) {
                  ...
                  return DataNotFoundWidget(onRefresh: _onRefresh, infoMessage: "There are no past visitors", kToolbarCount: 4,);
                }
              },
            ),
          ),
  ...
  Map<String, List<Entry>> _getGroupedData(){
    ...
    for (var entry in data) {
      final String dateKey = _formatDate(entry.entryTime!);
