...
class VisitorDeniedCard extends StatelessWidget {
  ...
  Widget _buildApprovalInfo() {
    final deniedBy = data.guardStatus?.guard?.userName ?? 'NA';
    final rejectedBy = data.societyDetails?.societyApartments?[0].entryStatus?.rejectedBy?.userName ?? 'NA';
