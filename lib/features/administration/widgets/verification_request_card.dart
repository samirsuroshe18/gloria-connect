...
class VerificationRequestCard extends StatelessWidget {
  ...
  void _showDocumentDialog(BuildContext context, {
    ...
    //                 children: [
    //                   Text(
    //                     isTenantAgreement ? 'Tenant Agreement' : 'Ownership Document',
    ...
    //                       },
    //                     ),
    //                     if (isTenantAgreement && startDate != null && endDate != null)
    //                       Container(
    //                         padding: const EdgeInsets.all(16),
    //                         color: Colors.grey.shade50,
    //                         child: Column(
    //                           children: [
    //                             _buildDateRow('Agreement Start', startDate),
    //                             const SizedBox(height: 8),
    //                             _buildDateRow('Agreement End', endDate),
    //                           ],
    //                         ),
    //                       ),
    //                   ],
