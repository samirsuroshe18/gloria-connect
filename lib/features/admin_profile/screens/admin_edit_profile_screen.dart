...
import 'package:gloria_connect/features/admin_profile/widgets/custom_input_field.dart';
import 'package:gloria_connect/features/admin_profile/widgets/edit_profile_section.dart';
...
class AdminEditProfileScreen extends StatefulWidget {
  ...
  const AdminEditProfileScreen({super.key, this.data});
...
class _AdminEditProfileScreenState extends State<AdminEditProfileScreen> {
  ...
  Future<void> _saveChanges() async {
    if(widget.data?.userName == _nameController.text && _selectedImage == null){
      CustomSnackBar.show(context: context, message: 'No changes were made.', type: SnackBarType.error);
      return;
    }
